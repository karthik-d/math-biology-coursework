...
def sweep_alpha_max():
	...
	for idx, c in zip(selected_indices, colors):
		...
		ax2.plot(x_null, y_vals, c=c, lw=2, label=f'x-null atalpha_max={alpha_max:.2f}')
		ax2.plot(x_vals, y_null, c='k', lw=2, ls='--', label='y-null (not perturbed)' if idx == 0 else None)
