...
class TestNewtonSystem(unittest.TestCase):
	...
	def test_linear_system_2x2_diagonal(self):
		"""Diagonal 2x2 system, trivial solution."""
		A = np.array([[5, 0],
					[0, 3]])
		b = np.array([10, 6])
		F = lambda x: A @ x - b
	...
	def test_linear_system_2x2_lower_triangular(self):
		"""Lower-triangular 2x2 system."""
		A = np.array([[3, 0],
					[2, 1]])
		b = np.array([6, 5])
		F = lambda x: A @ x - b
